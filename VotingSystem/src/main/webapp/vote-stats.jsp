...
<%@page import="voting.system.database.VotingBin"%>
<%@page import="java.util.List"%>
<%@page import="voting.system.domain.Vote"%>
	...
	<div id="page">
		<div id="header">
			...
			VotingBin vb = new VotingBin();
				int javaCount = 0, javascriptCount = 0, pythonCount = 0;
				List<Vote> list = vb.displayVotingStatistics();
				for (Vote v : list) {
					javaCount = v.getJavaCount();
					javascriptCount = v.getJavascriptCount();
						...
						<center>
							<table cellspacing=0 cellpadding="10">
								<tr>
									...
									<td><input type="text" id="java" value="<%=javaCount%>"
										name="java" size="10" disabled="disabled"></td>
								</tr>
								<tr>
									<td align=left style="color: #295071">JavaScript:</td>
									<td><input type="text" id="javascript"
										value="<%=javascriptCount%>" name="javascript" size="10"
										disabled="disabled"></td>
								</tr>
								<tr>
									<td align=left style="color: #295071">Python:</td>
									<td><input type="text" id="python"
										value="<%=pythonCount%>" name="python" size="10"
										disabled="disabled"></td>
								</tr>
							</table>
						</center>
			...
			<div id="footer">
				<div>
					<div class="section">
						<p style="text-align: center;">Copyright &copy; Online Voting
